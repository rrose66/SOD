...
public class BuildSOD 
{
	...
	public static void main(String[] args) 
	{
		...
		strMsg = "Click Yes after manually deleting FEDEBOM_PRODUCTION_USERS.csv and renaming N_FEDEBOM_PRODUCTION_USERS.csv";
		...
		intDialogButton=JOptionPane.YES_NO_CANCEL_OPTION;
		strMsg = "After removing all records from Conflicts, click Yes to run all the Alteryx work flows that generate data for the SOD";
